...
const AddFood = () => {
  ...
  return (
    <div className=" mx-auto py-8 bg-white shadow-lg rounded-xl mt-24">
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="md:col-span-2 text-center">
          <button type="submit" className="btn btn-outline text-[#e43c1c] hover:bg-[#e43c1c] lg:mt-6 hover:text-white px-10">
            Add Item
          </button>
        </div>
      </form>
